...
class Repeatable_Section_Counters extends Repeatable_Section {
	...
	public function layout_fields() {
		return array(
			...
			'counters_row_spacing_top'           => array(
				'id'          => 'counters_row_spacing_top',
				'type'        => 'select',
			...
			'counters_row_spacing_bottom'        => array(
				'id'          => 'counters_row_spacing_bottom',
				'type'        => 'select',
