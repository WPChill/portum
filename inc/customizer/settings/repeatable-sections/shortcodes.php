...
class Repeatable_Section_Shortcodes extends Repeatable_Section {
	...
	public function layout_fields() {
		return array(
			...
			'shortcodes_row_spacing_top'           => array(
				'id'          => 'shortcodes_row_spacing_top',
				'type'        => 'select',
			...
			'shortcodes_row_spacing_bottom'        => array(
				'id'          => 'shortcodes_row_spacing_bottom',
				'type'        => 'select',
	...
	public function background_fields() {
		...
		return array(
			'shortcodes_background_type'     => array(
				...
				'group'       => 'background',
				'choices'     => array(
					'solid' => __( 'Solid', 'epsilon-framework' ),
					'image' => __( 'Image', 'epsilon-framework' ),
				),
			),
	...
	public function color_fields() {
		return array(
			'shortcodes_heading_color' => array(
