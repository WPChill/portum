...
class Repeatable_Section_Contact extends Repeatable_Section {
	...
	public function layout_fields() {
		return array(
			...
			'contact_row_spacing_top'           => array(
				'id'          => 'contact_row_spacing_top',
				'type'        => 'select',
			...
			'contact_row_spacing_bottom'        => array(
				'id'          => 'contact_row_spacing_bottom',
				'type'        => 'select',
