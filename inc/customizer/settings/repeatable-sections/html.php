...
/**
 * Class Repeatable_Section_html
 */
class Repeatable_Section_HTML extends Repeatable_Section {
	...
	public function set_title() {
		$this->title = esc_html__( 'Custom HTML', 'portum' );
	}
	...
	public function set_description() {
		$this->description = esc_html__( 'a section where you can input your own custom HTML code', 'portum' );
	}
	...
	public function set_image() {
		$this->image = esc_url( get_template_directory_uri() . '/assets/images/sections/ewf-icon-section-html.png' );
	}
	...
	public function layout_fields() {
		$custom_fields = array(
 			'html_row_title_align'           => array(
				'id'          => 'html_row_title_align',
				'type'        => 'select',
			...
			'html_column_stretch'            => array(
				'id'          => 'html_column_stretch',
				'type'        => 'select',
 			...
 			'html_column_alignment'          => array(
				'id'          => 'html_column_alignment',
				'type'        => 'select',
 			...
 			'html_column_vertical_alignment' => array(
				'id'          => 'html_column_vertical_alignment',
				'type'        => 'select',
	...
	public function background_fields() {
		...
		return array(
			'html_background_type'        => array(
				'id'      => 'html_background_type',
			...
			'html_background_color'       => array(
				'id'         => 'html_background_color',
				...
				'group'      => 'background',
				'condition'  => array(
					'html_background_type',
					'bgcolor',
				),
			),
			'html_background_image'       => array(
				'id'          => 'html_background_image',
			...
			'html_background_image_color' => array(
				'id'         => 'html_background_color',
			...
			'html_background_position'    => array(
				'id'          => 'html_background_position',
			...
			'html_background_size'        => array(
				'id'          => 'html_background_size',
			...
			'html_background_repeat'      => array(
				'id'          => 'html_background_repeat',
			...
			'html_background_parallax'    => array(
				'id'          => 'html_background_parallax',
	...
	public function color_fields() {
		return array(
			'html_title_misc_font_color' => array(
			...
			'html_text_misc_font_color'    => array(
				'selectors'     => array( 'p' ),
				'css-attribute' => 'color',
				'default'       => '',
	...
	public function normal_fields() {
		return array(
			'html_title'                => array(
				...
				'type'              => 'text',
				'default'           => esc_html__( 'Learn more html us and how can we help you:', 'portum' ),
