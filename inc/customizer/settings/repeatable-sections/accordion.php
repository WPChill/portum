...
/**
 * Class Repeatable_Section_Accordion
 */
class Repeatable_Section_Accordion extends Repeatable_Section {
	/**
	 * Sets the section id
	 */
	...
	public function set_title() {
		$this->title = esc_html__( 'F.A.Q. Section', 'portum' );
	}
	...
	public function layout_fields() {
		$custom_fields = array(
			...
			'accordion_column_stretch'            => array(
				'id'          => 'accordion_column_stretch',
				'type'        => 'select',
			...
			'accordion_column_vertical_alignment' => array(
				'id'          => 'accordion_column_vertical_alignment',
				'type'        => 'select',
