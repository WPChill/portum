...
class Repeatable_Section_Pricing extends Repeatable_Section {
	...
	public function layout_fields() {
		return array(
			...
			'pricing_row_spacing_top'           => array(
				'id'          => 'pricing_row_spacing_top',
				'type'        => 'select',
			...
			'pricing_row_spacing_bottom'        => array(
				'id'          => 'pricing_row_spacing_bottom',
				'type'        => 'select',
