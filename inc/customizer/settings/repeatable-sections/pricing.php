...
/**
 * Class Repeatable_Section_Pricing
 */
class Repeatable_Section_Pricing extends Repeatable_Section {
	...
	public function set_title() {
		$this->title = esc_html__( 'Pricing', 'portum' );
	}
	...
	public function set_description() {
		$this->description = esc_html__( 'Pricing section. It retrieves content from Theme Content / Pricing', 'portum' );
	}
	...
	public function set_image() {
		$this->image = esc_url( get_template_directory_uri() . '/assets/images/sections/ewf-icon-section-pricing-pt.png' );
	}
	...
	public function layout_fields() {
		$custom_fields = array(
			'pricing_row_title_align'           => array(
				'id'          => 'pricing_row_title_align',
				'type'        => 'select',
			...
			'pricing_column_stretch'            => array(
				'id'          => 'pricing_column_stretch',
				'type'        => 'select',
			...
			'pricing_column_alignment'          => array(
				'id'          => 'pricing_column_alignment',
				'type'        => 'select',
			...
			'pricing_column_vertical_alignment' => array(
				'id'          => 'pricing_column_vertical_alignment',
				'type'        => 'select',
	...
	public function background_fields() {
		...
		return array(
			...
			'pricing_background_color'       => array(
				...
				'group'      => 'background',
				'condition'  => array(
					'pricing_background_type',
					'bgcolor',
				),
			),
			'pricing_background_image'       => array(
				'id'          => 'pricing_background_image',
			...
			'pricing_background_image_color' => array(
				'id'         => 'pricing_background_color',
			...
			'pricing_background_position'    => array(
				'id'          => 'pricing_background_position',
			...
			'pricing_background_size'        => array(
				'id'          => 'pricing_background_size',
			...
			'pricing_background_repeat'      => array(
				'id'          => 'pricing_background_repeat',
			...
			'pricing_background_parallax'    => array(
				'id'          => 'pricing_background_parallax',
	...
	public function color_fields() {
		return array(
			'pricing_title_misc_font_color' => array(
			...
			'pricing_text_misc_font_color'  => array(
				'selectors'     => array( 'p' ),
				'css-attribute' => 'color',
				'default'       => '',
