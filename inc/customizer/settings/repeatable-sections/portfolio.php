...
class Repeatable_Section_Portfolio extends Repeatable_Section {
	...
	public function layout_fields() {
		return array(
			...
			'portfolio_row_spacing_top'           => array(
				'id'          => 'portfolio_row_spacing_top',
				'type'        => 'select',
			...
			'portfolio_row_spacing_bottom'        => array(
				'id'          => 'portfolio_row_spacing_bottom',
				'type'        => 'select',
