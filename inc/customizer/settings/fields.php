	...
	array(
		...
		'fields'       => array(
			...
			'slide_title_animation'         => array(
				...
				'default' => 'fadeInDown',
				'choices' => array(
					'bounceIn'   => __( 'Bounce In', 'portum' ),
					'bounceInUp'   => __( 'Bounce In Up', 'portum' ),
					'bounceInDown' => __( 'Bounce In Down', 'portum' ),
					'bounceInLeft' => __( 'Bounce In Left', 'portum' ),
					'bounceInRight' => __( 'Bounce In Right', 'portum' ),
					'fadeIn' => __( 'Fade In', 'portum' ),
					'fadeInUp' => __( 'Fade In Down', 'portum' ),
					'fadeInDown' => __( 'Fade In Down', 'portum' ),
					'fadeInLeft' => __( 'Fade In Left', 'portum' ),
					'fadeInRight' => __( 'Fade In Right', 'portum' ),
					'flipInX' => __( 'Flip In X', 'portum' ),
					'flipInY' => __( 'Flip In Y', 'portum' ),
					'lightSpeedIn' => __( 'Light Speed In', 'portum' ),
					'zoomIn' => __( 'Zoom In', 'portum' ),
					'zoomInUp' => __( 'Zoom In Up', 'portum' ),
					'zoomInDown' => __( 'Zoom In Down', 'portum' ),
					'slideInUp' => __( 'Slide In Up', 'portum' ),
					'slideInDown' => __( 'Slide In Down', 'portum' ),
					'slideInLeft' => __( 'Slide In Left', 'portum' ),
					'slideInRight' => __( 'Slide In Right', 'portum' ),
				),
			),
