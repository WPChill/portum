...
$parent_attr = array(
	//'id'    => ! empty( $fields['map_section_unique_id'] ) ? array( $fields['map_section_unique_id'] ) : array(),
	'id' => array(),
...
<section data-customizer-section-id="portum_repeatable_section" data-section="<?php echo esc_attr( $section_id ); ?>" class="google-map-section" <?php echo ! empty( $fields['google_map_section_unique_id'] ) ? 'id="' . $fields['google_map_section_unique_id'] . '"' : ''; ?>>
	<div <?php $attr_helper->generate_attributes( $parent_attr ); ?>>
		<?php if ( ! empty( $api ) ) : ?>
			...
			<div class="map-canvas" data-zoom="<?php echo esc_attr( $fields['google_map_zoom'] ); ?>" data-address="<?php echo esc_attr( $fields['google_map_address'] ); ?>"></div>
		<?php endif; ?>
		<div class="container">
