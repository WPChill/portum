...
$grouping = array( 'values'   => $fields['google_map_grouping'], 'group_by' => 'contact_title',);
...
<section data-customizer-section-id="portum_repeatable_section" data-section="<?php echo esc_attr( $section_id ); ?>" class="google-map-section" <?php echo ! empty( $fields['google_map_section_unique_id'] ) ? 'id="' . $fields['google_map_section_unique_id'] . '"' : ''; ?>>
	<div <?php $attr_helper->generate_attributes( $parent_attr ); ?> >
		...
		<?php if ($fields['google_map_row_title_align'] == 'right'){ ?>
			<?php
			...
			<div class="<?php echo esc_attr( Portum_Helper::container_class( 'google_map', $fields ) ); ?>">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<?php echo wp_kses_post( Portum_Helper::generate_section_title( $fields['google_map_subtitle'], $fields['google_map_title'], false ) ); ?>
		...
		<?php } elseif ($fields['google_map_row_title_align'] == 'left'){ ?>
