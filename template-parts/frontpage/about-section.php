...
$button_primary  = ! empty( $fields['about_button_primary_label'] ) ? $fields['about_button_primary_label'] : '';
$button_primary .= ! empty( $fields['about_button_primary_url'] ) ? $fields['about_button_primary_url'] : '';
$parent_attr     = array(
